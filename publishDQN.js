...
const { fetchDQN } = require("./readDQN.js");
...
const runDQN = async () => {
  try {
    for (let index = 1; index <= 1; index++) {
      ...
      await fetchDQN(presharedkey, ann_link.copy().toString());
...
runDQN().then(() => console.log("Happy Coding! :)"));
