...
* @returns {Author}
*/
  static fromClient(client: Client, seed: string, implementation: number): Author;
/**
* @param {Client} client
...
*/
  node(node: string): ClientBuilder;
/**
* Adds an IOTA node by its URL to be used as primary node, with optional jwt and or basic authentication
* @param {string} node
* @param {NodeAuthOptions} options
* @returns {ClientBuilder}
*/
  primaryNode(node: string, options: NodeAuthOptions): ClientBuilder;
/**
...
* @returns {ClientBuilder}
*/
  primaryPowNode(node: string, options: NodeAuthOptions): ClientBuilder;
/**
...
* @returns {ClientBuilder}
*/
  permanode(node: string, options: NodeAuthOptions): ClientBuilder;
/**
...
* @returns {ClientBuilder}
*/
  nodeAuth(node: string, options: NodeAuthOptions): ClientBuilder;
/**
...
* @returns {any}
*/
  nodePoolUrls(urls: (string)[]): any;
/**
* Set if quroum should be used or not
* @param {boolean} quorum_on
* @returns {ClientBuilder}
*/
  quorum(quorum_on: boolean): ClientBuilder;
/**
* Set amount of nodes which should be used for quorum
* @param {number} quorum_size
* @returns {ClientBuilder}
*/
  quorumSize(quorum_size: number): ClientBuilder;
/**
* Set quorum_threshold
* @param {number} quorum_threshold
* @returns {ClientBuilder}
*/
  quorumThreshold(quorum_threshold: number): ClientBuilder;
/**
...
* @param {BigInt} node_sync_interval_sec
* @returns {ClientBuilder}
*/
  nodeSyncInterval(node_sync_interval_sec: BigInt): ClientBuilder;
/**
...
* @param {BigInt} timeout_sec
* @returns {ClientBuilder}
*/
  requestTimeout(timeout_sec: BigInt): ClientBuilder;
/**
...
* @returns {ClientBuilder}
*/
  apiTimeout(api: number, timeout_sec: BigInt): ClientBuilder;
/**
...
* @param {BigInt} tips_interval
* @returns {ClientBuilder}
*/
  tipsInterval(tips_interval: BigInt): ClientBuilder;
/**
* Build the Streams Client instance.
* @param {SendOptions} options
* @returns {any}
*/
  finish(options: SendOptions): any;
}
/**
*/
export class Cursor {
...
/**
*/
export class NodeAuthOptions {
  free(): void;
/**
*/
  constructor();
/**
* @returns {NodeAuthOptions}
*/
  clone(): NodeAuthOptions;
/**
* @param {string} name
*/
  auth_name: string;
...
* @returns {Subscriber}
*/
  static fromClient(client: Client, seed: string): Subscriber;
/**
* @param {Client} client
* @param {Uint8Array} bytes
* @param {string} password
...
export interface InitOutput {
  ...
  readonly __wbg_nodeauthoptions_free: (a: number) => void;
  readonly nodeauthoptions_new: () => number;
  readonly nodeauthoptions_set_jwt: (a: number, b: number, c: number) => void;
  readonly nodeauthoptions_set_auth_name: (a: number, b: number, c: number) => void;
  readonly nodeauthoptions_set_auth_password: (a: number, b: number, c: number) => void;
  readonly nodeauthoptions_clone: (a: number) => number;
  readonly __wbg_clientbuilder_free: (a: number) => void;
  readonly clientbuilder_default: () => number;
  readonly clientbuilder_node: (a: number, b: number, c: number) => number;
  readonly clientbuilder_primaryNode: (a: number, b: number, c: number, d: number) => number;
  readonly clientbuilder_primaryPowNode: (a: number, b: number, c: number, d: number) => number;
  readonly clientbuilder_permanode: (a: number, b: number, c: number, d: number) => number;
  readonly clientbuilder_nodeAuth: (a: number, b: number, c: number, d: number) => number;
  readonly clientbuilder_nodes: (a: number, b: number, c: number) => number;
  readonly clientbuilder_nodePoolUrls: (a: number, b: number, c: number) => number;
  ...
  readonly clientbuilder_nodeSyncInterval: (a: number, b: number, c: number) => number;
  readonly clientbuilder_disableNodeSync: (a: number) => number;
  readonly clientbuilder_offlineMode: (a: number) => number;
  readonly clientbuilder_requestTimeout: (a: number, b: number, c: number) => number;
  ...
  readonly clientbuilder_tipsInterval: (a: number, b: number, c: number) => number;
  readonly clientbuilder_finish: (a: number, b: number) => number;
  readonly __wbindgen_malloc: (a: number) => number;
  readonly __wbindgen_realloc: (a: number, b: number, c: number) => number;
  readonly __wbindgen_export_2: WebAssembly.Table;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4e01c41b5dd9bdd8: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc041826788ee70aa: (a: number, b: number) => void;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h39fc7bbf4da11fb6: (a: number, b: number, c: number, d: number) => void;
}
