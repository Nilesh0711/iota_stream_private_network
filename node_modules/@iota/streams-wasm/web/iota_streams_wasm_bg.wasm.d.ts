...
export function __wbg_nodeauthoptions_free(a: number): void;
export function nodeauthoptions_new(): number;
export function nodeauthoptions_set_jwt(a: number, b: number, c: number): void;
export function nodeauthoptions_set_auth_name(a: number, b: number, c: number): void;
export function nodeauthoptions_set_auth_password(a: number, b: number, c: number): void;
export function nodeauthoptions_clone(a: number): number;
export function __wbg_clientbuilder_free(a: number): void;
export function clientbuilder_default(): number;
export function clientbuilder_node(a: number, b: number, c: number): number;
export function clientbuilder_primaryNode(a: number, b: number, c: number, d: number): number;
export function clientbuilder_primaryPowNode(a: number, b: number, c: number, d: number): number;
export function clientbuilder_permanode(a: number, b: number, c: number, d: number): number;
export function clientbuilder_nodeAuth(a: number, b: number, c: number, d: number): number;
export function clientbuilder_nodes(a: number, b: number, c: number): number;
export function clientbuilder_nodePoolUrls(a: number, b: number, c: number): number;
...
export function clientbuilder_nodeSyncInterval(a: number, b: number, c: number): number;
export function clientbuilder_disableNodeSync(a: number): number;
export function clientbuilder_offlineMode(a: number): number;
export function clientbuilder_requestTimeout(a: number, b: number, c: number): number;
...
export function clientbuilder_tipsInterval(a: number, b: number, c: number): number;
export function clientbuilder_finish(a: number, b: number): number;
export function __wbindgen_malloc(a: number): number;
export function __wbindgen_realloc(a: number, b: number, c: number): number;
export const __wbindgen_export_2: WebAssembly.Table;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4e01c41b5dd9bdd8(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc041826788ee70aa(a: number, b: number): void;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function wasm_bindgen__convert__closures__invoke2_mut__h39fc7bbf4da11fb6(a: number, b: number, c: number, d: number): void;
