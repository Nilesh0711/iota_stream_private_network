...
export interface InitOutput {
  ...
  readonly addressgetter_accountIndex: (a: number, b: number) => number;
  readonly addressgetter_range: (a: number, b: number, c: number) => number;
  readonly addressgetter_bech32Hrp: (a: number, b: number, c: number) => number;
  readonly addressgetter_includeInternal: (a: number) => number;
  readonly addressgetter_get: (a: number) => number;
  ...
  readonly client_getInfo: (a: number) => number;
  readonly client_getNodeInfo: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
  readonly client_networkInfo: (a: number) => number;
  readonly client_getNetworkId: (a: number) => number;
  readonly client_getBech32Hrp: (a: number) => number;
  readonly client_getMinPowScore: (a: number) => number;
  readonly client_getHealth: (a: number) => number;
  readonly client_getTips: (a: number) => number;
  readonly client_getPeers: (a: number) => number;
  readonly client_getOutput: (a: number, b: number, c: number) => number;
  readonly client_findMessages: (a: number, b: number, c: number) => number;
  readonly client_findInputs: (a: number, b: number, c: number, d: number) => number;
  readonly client_findOutputs: (a: number, b: number, c: number) => number;
  readonly client_getAddressBalances: (a: number, b: number) => number;
  readonly client_getMilestone: (a: number, b: number) => number;
  readonly client_getMilestoneUtxoChanges: (a: number, b: number) => number;
  readonly client_getReceipts: (a: number) => number;
  readonly client_getReceiptsMigratedAt: (a: number, b: number) => number;
  readonly client_getTreasury: (a: number) => number;
  readonly client_getIncludedMessage: (a: number, b: number, c: number) => number;
  readonly client_postMessage: (a: number, b: number) => number;
  readonly client_retry: (a: number, b: number, c: number) => number;
  readonly client_retryUntilIncluded: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
  readonly client_reattach: (a: number, b: number, c: number) => number;
  readonly client_promote: (a: number, b: number, c: number) => number;
  readonly client_consolidateFunds: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly client_bech32ToHex: (a: number, b: number, c: number, d: number) => void;
  readonly client_hexToBech32: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly client_hexPublicKeyToBech32Address: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly balancegetter_accountIndex: (a: number, b: number) => number;
  readonly balancegetter_initialAddressIndex: (a: number, b: number) => number;
  readonly balancegetter_gap_limit: (a: number, b: number) => number;
  readonly balancegetter_get: (a: number) => number;
  readonly __wbg_getaddressbuilder_free: (a: number) => void;
  readonly getaddressbuilder_new: (a: number) => number;
  readonly getaddressbuilder_balance: (a: number, b: number, c: number) => number;
  readonly getaddressbuilder_outputs: (a: number, b: number, c: number, d: number) => number;
  readonly __wbg_clientbuilder_free: (a: number) => void;
  readonly clientbuilder_new: () => number;
  readonly clientbuilder_node: (a: number, b: number, c: number) => number;
  readonly clientbuilder_primaryNode: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
  readonly clientbuilder_primaryPowNode: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
  readonly clientbuilder_permanode: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
  readonly clientbuilder_nodeAuth: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
  readonly clientbuilder_nodes: (a: number, b: number) => number;
  readonly clientbuilder_nodeSyncInterval: (a: number, b: number) => number;
  readonly clientbuilder_nodeSyncDisabled: (a: number) => number;
  readonly clientbuilder_offlineMode: (a: number) => number;
  readonly clientbuilder_nodePoolUrls: (a: number, b: number) => number;
  readonly clientbuilder_quorum: (a: number, b: number) => number;
  readonly clientbuilder_quorumSize: (a: number, b: number) => number;
  readonly clientbuilder_quorumThreshold: (a: number, b: number) => number;
  readonly clientbuilder_network: (a: number, b: number, c: number) => number;
  readonly clientbuilder_localPow: (a: number, b: number) => number;
  readonly clientbuilder_tipsInterval: (a: number, b: number) => number;
  readonly clientbuilder_requestTimeout: (a: number, b: number) => number;
  readonly clientbuilder_apiTimeout: (a: number, b: number, c: number, d: number) => number;
  readonly clientbuilder_build: (a: number) => number;
  ...
  readonly unspentaddressgetter_accountIndex: (a: number, b: number) => number;
  readonly unspentaddressgetter_initialAddressIndex: (a: number, b: number) => number;
  readonly unspentaddressgetter_get: (a: number) => number;
  readonly __wbg_messagebuilder_free: (a: number) => void;
  readonly messagebuilder_new: (a: number) => number;
  readonly messagebuilder_index: (a: number, b: number, c: number) => number;
  readonly messagebuilder_data: (a: number, b: number, c: number) => number;
  readonly messagebuilder_seed: (a: number, b: number, c: number) => number;
  readonly messagebuilder_accountIndex: (a: number, b: number) => number;
  readonly messagebuilder_initialAddressIndex: (a: number, b: number) => number;
  readonly messagebuilder_parents: (a: number, b: number) => number;
  readonly messagebuilder_input: (a: number, b: number, c: number) => number;
  readonly messagebuilder_inputRange: (a: number, b: number, c: number) => number;
  readonly messagebuilder_output: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly messagebuilder_dustAllowanceOutput: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly messagebuilder_prepareTransaction: (a: number) => number;
  readonly messagebuilder_signTransaction: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
  readonly messagebuilder_finishMessage: (a: number, b: number) => number;
  readonly messagebuilder_submit: (a: number) => number;
  readonly __wbg_messagegetter_free: (a: number) => void;
  readonly messagegetter_new: (a: number) => number;
  readonly messagegetter_index: (a: number, b: number, c: number) => number;
  readonly messagegetter_data: (a: number, b: number, c: number) => number;
  readonly messagegetter_raw: (a: number, b: number, c: number) => number;
  readonly messagegetter_children: (a: number, b: number, c: number) => number;
  readonly messagegetter_metadata: (a: number, b: number, c: number) => number;
  ...
  readonly author_reset_state: (a: number) => void;
  readonly author_store_new_subscriber: (a: number, b: number, c: number) => void;
  readonly author_remove_subscriber: (a: number, b: number, c: number) => void;
  readonly author_remove_psk: (a: number, b: number, c: number) => void;
  ...
  readonly subscriber_remove_psk: (a: number, b: number, c: number) => void;
  ...
  readonly address_parse: (a: number, b: number) => number;
  ...
  readonly channeladdress_parse: (a: number, b: number) => number;
  ...
  readonly msgid_parse: (a: number, b: number) => number;
  ...
  readonly nextmsgid_identifier: (a: number, b: number) => void;
  readonly nextmsgid_link: (a: number) => number;
  readonly userresponse_new: (a: number, b: number, c: number) => number;
  readonly userresponse_fromStrings: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4683ba551cf2e647: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h60f811762e8501ff: (a: number, b: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h58f8428c3c06941c: (a: number, b: number, c: number, d: number) => void;
